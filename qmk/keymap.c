...
//    ),
    ...
    NEO_SHIFT,NEO_M4, DE_UDIA, DE_ODIA, DE_ADIA, DE_P,   DE_Z,   DE_B,   DE_M,    DE_COMM, DE_DOT,  DE_J,             KC_NO,   NEO_SHIFT,              KC_UP,             KC_P1,   KC_P2,   KC_P3,   KC_PEQL,    KC_EXEC, KC_PSTE,
    ...
    ______, ______,S(DE_UDIA),S(DE_ODIA),S(DE_ADIA), S(DE_P),S(DE_Z),S(DE_B), S(DE_M),UC(L'–'),UC(L'•'), S(DE_J),           ______, ______,              ______,           ______,______,______,______,    ______,______,
    ______, ______,    ______,   ______,     ______,          ______,         ______,    ______, ______, ______,   ______,  ______, ______,       ______,______,______,    ______,       ______,______,    ______,______
    ),
    ...
    [_NEO_THREE] = LAYOUT_all(
                      ______,   ______,   ______,  ______,  ______,  ______,  ______,  ______,   ______,  ______,  ______,  ______,
    ______,           ______,   ______,   ______,  ______,  ______,  ______,  ______,  ______,   ______,  ______,  ______,  ______,                ______,______,______,    ______,______,______,______,    ______,
    ______,  ______, DE_SUP2,  DE_SUP3, UC(L'›'),UC(L'‹'),UC(L'¢'),UC(L'¥'), DE_COMM,UC(L'‘'), UC(L'’'),UC(L'—'),  ______,  ______, ______,        ______,______,______,    ______,______,______,______,    ______,______,
    ______, UC(L'…'),  ______, DE_LBRC,  DE_RBRC,  ______, DE_EXLM, DE_LABK, DE_RABK, DE_EQL,   DE_AMPR,UC(L'ſ'),  ______,          ______,        ______,______,______,    ______,______,______,______,    ______,______,
    ______, DE_BSLS, DE_SLSH,  DE_LCBR,  DE_RCBR, DE_ASTR, DE_QUES, DE_LPRN, DE_RPRN,DE_MINS,   DE_COLN,   DE_AT,           ______, ______,                                 ______,______,______,______,    ______,______,
